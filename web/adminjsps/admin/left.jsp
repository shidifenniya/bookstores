...
function load() {
	...
	bar1.add("图书管理", "查看图书", "<c:url value='/AdminBookServlet?method=findAdd'/>", "body");
	...
	bar1.add("订单管理", "未付款订单", "<c:url value='/AdminOrderServlet?method=stateOrder&state=0'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/AdminOrderServlet?method=stateOrder&state=1'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/AdminOrderServlet?method=stateOrder&state=2'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/AdminOrderServlet?method=stateOrder&state=3'/>", "body");
